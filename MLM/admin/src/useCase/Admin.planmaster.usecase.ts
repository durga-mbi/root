...
export const getplanByIdUsecase = async (id: number) => {
  return await getplanbyIdRepo(id);
};
export const updatePlanUSecase = async (id: number, data: UpdatePlanDto) => {
...
export const deleteplanusecase = async (id: number) => {
